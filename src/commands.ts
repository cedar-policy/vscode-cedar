...
export const COMMAND_CEDAR_JSONPREVIEW = 'cedar.jsonpreview';
...
export const COMMAND_CEDAR_ENTITIESADD = 'cedar.entitiesadd';
export const COMMAND_CEDAR_CLEARPROBLEMS = 'cedar.clearproblems';
